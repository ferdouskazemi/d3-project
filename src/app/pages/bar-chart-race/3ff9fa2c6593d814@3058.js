...
export default function define(runtime, observer) {
  ...
  // اینجا اگر از فایل اطلاعات رو بخونیم یک خطای شبیه به این که نیاز است یه لودر حاصی رو تو تنظیمات کانفیگ ایجاد کنیم میده 
  
  // const fileAttachments = new Map([["category-brands.csv", require("./files/category-brands.csv")]]);
